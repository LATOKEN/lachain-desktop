...
logger.info('lachain started', global.appVersion || app.getVersion())
    ...
    submenu: [
      {
        ...
        click: () => {
          shell.openExternal('https://lachain.io/')
        },
      },
      {
        label: i18next.t('Explorer'),
        click: () => {
          shell.openExternal('http://payments.nekotal.tech:8484/account/')
        },
      },
      {
        type: 'separator',
